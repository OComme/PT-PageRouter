...
//
//导入预编译的方法
#ifndef PTDefineHeader_h
#define PTDefineHeader_h
...
//像素等比例转换屏幕尺寸
#define CUSTOM_PX(value) ({ __typeof__(value) __size = (value); \
(__size)/750.0f*[UIScreen mainScreen].bounds.size.width; })
